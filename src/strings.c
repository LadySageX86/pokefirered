...
const u8 gExpandedPlaceholder_Red[] = _("MEKWE'K");
const u8 gExpandedPlaceholder_Green[] = _("ESKIT");
const u8 gText_EggNickname[] = _("WA'W");
const u8 gText_MenuPokemon[] = _("POKéMON");
const u8 gText_NewGame[] = _("PILEI");
const u8 gText_Continue[] = _("SIAWA'SIT");
...
const u8 gText_Controls[] = _("ALSUMATL");
ALIGNED(4) const u8 gText_PickOk[] = _("{DPAD_UPDOWN}えらぶ {A_BUTTON}けってい");
ALIGNED(4) const u8 gText_ABUTTONNext[] = _("{A_BUTTON}NIKANA'SIT");
ALIGNED(4) const u8 gText_ABUTTONNext_BBUTTONBack[] = _("{A_BUTTON}NIKANA'SIT {B_BUTTON}APAJA'SIT");
ALIGNED(4) const u8 gText_UPDOWNPick_ABUTTONNext_BBUTTONBack[] = _("{DPAD_UPDOWN}MEKNATL {A_BUTTON}NIKANA'SIT {B_BUTTON}WEJITU'WET");
ALIGNED(4) const u8 gText_UPDOWNPick_ABUTTONBBUTTONCancel[] = _("{DPAD_UPDOWN}MEKNATL {A_BUTTON}{B_BUTTON}WEJITU'WET");
ALIGNED(4) const u8 gText_ABUTTONExit[] = _("{A_BUTTON}TEWIET");
const u8 gText_Boy[] = _("LPA'TUJ");
const u8 gText_Girl[] = _("E'PITE'JI'J");
const u8 gText_PokedexTableOfContents[] = _("POKéDEX   TABLE OF CONTENTS");
const u8 gText_PickOK[] = _("{DPAD_UPDOWN}MEKNATL {A_BUTTON}E'E");
...
const u8 gText_DexCategory_GrasslandPkmn[] = _("Msiku POKéMON");
const u8 gText_DexCategory_ForestPkmn[] = _("Nipukt POKéMON");
const u8 gText_DexCategory_WatersEdgePkmn[] = _("Apaqt POKéMON");
const u8 gText_DexCategory_SeaPkmn[] = _("Kta'n POKéMON");
const u8 gText_DexCategory_CavePkmn[] = _("Elmalqei POKéMON");
const u8 gText_DexCategory_MountainPkmn[] = _("Kmtn POKéMON");
const u8 gText_DexCategory_RoughTerrainPkmn[] = _("Kuntewik POKéMON");
const u8 gText_DexCategory_UrbanPkmn[] = _("Kjikan POKéMON");
const u8 gText_DexCategory_RarePkmn[] = _("Awije'jk POKéMON");
...
const u8 gText_PickOKExit[] = _("{DPAD_UPDOWN}MEKNATL {A_BUTTON}E'E {B_BUTTON}WEJITU'WET");
...
const u8 gSaveStatName_Player[] = _("KINAP");
const u8 gSaveStatName_Badges[] = _("PESSMKEWE'K");
...
const u8 gOtherText_Toss[] = _("TEWEKET");
...
const u8 gOtherText_Exit[] = _("TEWIET");
...
const u8 gText_MenuBag[] = _("MUNTI");
const u8 gText_MenuPokenav[] = _("ポケナビ");
const u8 gText_MenuPlayer[] = _("{PLAYER}");
const u8 gText_MenuSave[] = _("EWI'K'K");
const u8 gText_MenuOption[] = _("ELQWANIK");
const u8 gText_MenuExit[] = _("WEJITU'WET");
...
const u8 gText_PokeBalls2[] = _("POKé TU'AQANN");
const u8 gText_KeyItems2[] = _("KEY ITEMS");
const u8 gText_DepositItem[] = _("DEPOSIT ITEM");
const u8 gText_CloseBag[] = _("PKIJOQA'TUJ MUNTI");
...
const u8 gText_ShopBuy[] = _("PEKWATELK");
const u8 gText_ShopSell[] = _("NETUISKALATL");
const u8 gText_ShopQuit[] = _("ATIU!");
const u8 gText_InBagVar1[] = _("LIKPENIKN:{FONT_SMALL} {STR_VAR_1}");
const u8 gText_QuitShopping[] = _("Puna'toq makasan.");
...
const u8 gText_EggCantBattle[] = _("WA'W moqwa' matnk!{PAUSE_UNTIL_PRESS}");
...
ALIGNED(4) const u8 gText_ThatIsntAnEgg[] = _("A't moqwa' WA'W.");
const u8 gText_ChoosePokemon[] = _("Meknatl POKéMON.");
...
const u8 gText_OakImportantToGetToKnowPokemonThroughly[] = _("MIMKWAN: It's important to get to know\nyour POKéMON thoroughly.\p");
...
const u8 gText_CutATreeOrGrass[] = _("Musikta'sit miti'sk kisna msiku.");
const u8 gText_FlyToAKnownTown[] = _("Elaqsink keitmk kutan.");
const u8 gText_TravelOnWater[] = _("Asoqomasukwet.");
const u8 gText_MoveHeavyBoulders[] = _("Aja'sit espaps'ktek.");
const u8 gText_LightUpDarkness[] = _("Pitiatek kijitpa'qtuk.");
const u8 gText_ShatterACrackedRock[] = _("Shatter a cracked rock.");
const u8 gText_ClimbAWaterfall[] = _("Keskija'sit kapskw.");
...
const u8 gText_OK[] = _("E'E");
const u8 gOtherText_Quit[] = _("TEWIET");
const u8 gText_SawIt[] = _("みました");
const u8 gText_NotYet[] = _("これから");
const u8 gText_Yes[] = _("E'E");
const u8 gText_No[] = _("MOQWA'");
...
const u8 gText_ProfOakSPc[] = _("MIMKWAN LIKPENIKN");
...
const u8 gText_YourName[] = _("KI'LEWEI WISUN?");
const u8 gText_BoxName[] = _("UKTUTEM WISUN?");
const u8 gText_PkmnsNickname[] = _(" wisunkalul?");
const u8 gText_RivalsName[] = _("NUJI'JK WISUN?");
const u8 gText_MoveOkBack[] = _("{DPAD_ANY}AJA'SIT {A_BUTTON}E'E {B_BUTTON}APAJA'SIT");
...
const u8 gText_RegionMap_AButtonCancel[] = _("{A_BUTTON}WEJITU'WET");
const u8 gText_RegionMap_AButtonCancel2[] = _("{A_BUTTON}WEJITU'WET");
const u8 gText_RegionMap_AButtonSwitch[] = _("{A_BUTTON}SWITCH");
const u8 gText_RegionMap_AButtonOK[] = _("{A_BUTTON}E'E");
const u8 gText_RegionMap_DPadMove[] = _("{DPAD_ANY}AJA'SIT");
const u8 gText_RegionMap_UpDownPick[] = _("{DPAD_UPDOWN}MEKNATL");
...
const u8 gText_PokeSum_Controls_PageCancel[] = _("{DPAD_RIGHT}PAGE {A_BUTTON}WEJITU'WET");
const u8 gText_PokeSum_Controls_Cancel[] = _("{A_BUTTON}WEJITU'WET");
...
const u8 gText_PokeSum_Controls_Pick[] = _("{DPAD_UPDOWN}MEKNATL");
...
const u8 gText_TrainerCardName[] = _("WISUN: ");
const u8 gText_TrainerCardIDNo[] = _("IDNo.");
const u8 gText_TrainerCardMoney[] = _("SULEIWEI");
...
const u8 gText_TrainerCardTime[] = _("ALAPIMK");
...
const u8 gText_OptionMenuCancel[] = _("WEJITU'WET");
...
const u8 gText_SoundMono[] = _("NEWTE'");
const u8 gText_SoundStereo[] = _("TA'PU");
const u8 gTextJP_Type[] = _("タイプ");
const u8 gText_ButtonTypeHelp[] = _("APOQONMATI");
...
const u8 gText_SavingDontTurnOffThePower2[] = _("EWI'K'K…\nMOQWA' NAQASUA'TOQ!");
...
const u8 gStartMenuDesc_Bag[] = _("Te'sit maposl! Masqwa'latl papitaqann\npekwatelk, mesn'k, kisna we'jitoq.");
const u8 gStartMenuDesc_Player[] = _("Neiapt'k suleiwei aq iktikik kina'matnewey.");
const u8 gStartMenuDesc_Save[] = _("Ewi'k'k ki'lewei a'tukwaqan\naq atlasmu'teket.");
const u8 gStartMenuDesc_Option[] = _("Sa'se'wa'sit klusuaqann\nnqasi, ptlutaqnn, aq me'.");
const u8 gStartMenuDesc_Exit[] = _("Tewiet ELQWANIK.");
...
const u8 gText_And[] = _("Aq‥\p");
const u8 gText_MachineSet[] = _("Machine set!\p");
const u8 gText_Huh[] = _("Quq?");
...
const u8 gText_RegisteredTextChanged_SavingDontTurnOff[] = _("EWI'K'K‥\nDON'T TURN OFF THE POWER.");
...
const u8 gText_ThankYou[] = _("WELA'LIN");
...
const u8 gText_Player[] = _("KINAP");
const u8 gText_Time[] = _("ALAPIMK");
...
const u8 gText_SavingDontTurnOffPower[] = _("EWI'K'K…\nDON'T TURN OFF THE POWER.");
const u8 gText_CommunicationStandby4[] = _("Communication standby…");
const u8 gText_SavingDontTurnOffPower2[] = _("EWI'K'K...\nDON'T TURN OFF THE POWER."); // Unused
...
ALIGNED(4) const u8 gString_PokemonFireRed_Staff[] = _("Pokémon PuktewMekwe'k\nStaff");
ALIGNED(4) const u8 gString_PokemonLeafGreen_Staff[] = _("Pokémon NipiEskit\nStaff");
...
const u8 gText_HelpSystemControls_A_Next[] = _("{A_BUTTON}NIKANA'SIT");
...
const u8 gFameCheckerOakName[] = _("MIMKWAN");
const u8 gFameCheckerDaisyName[] = _("DAISY");
const u8 gFameCheckerBillName[] = _("SUL"); // Short form of Sulia'n
