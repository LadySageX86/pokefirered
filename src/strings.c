...
const u8 gText_EggCantBattle[] = _("An WA'W can't battle!{PAUSE_UNTIL_PRESS}");
...
const u8 gStartMenuDesc_Bag[] = _("Te'sit maposl! Masqwa'latl\npapitaqann pekwatelk, mesn'k, kisna we'jitoq.");
...
const u8 gFameCheckerOakName[] = _("MIMKWAQAN");
